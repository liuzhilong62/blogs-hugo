...
![在这里插入图片描述](/img/csdn/e9d3726e966d.png)
...
系统调用流程：
![在这里插入图片描述](/img/csdn/b1b0da7b7d74.png)
...
![在这里插入图片描述](/img/csdn/4b446b757f77.png)
...
![在这里插入图片描述](/img/csdn/92827b8dcc73.png)
...
![在这里插入图片描述](/img/csdn/d969a23e8ba9.png)
（https://www.geeksforgeeks.org/inter-process-communication-ipc/）

由于本身就是多个虚拟内存地址空间对应一个物理内存地址空间，所以只要把两个进程的地址空间中的一段指向同一物理内存即可。

![在这里插入图片描述](/img/csdn/1bc1a1357c78.png)
...
![在这里插入图片描述](/img/csdn/02d5376a22ed.png)
...
![在这里插入图片描述](/img/csdn/3e31e4f9f0eb.png)

单个页表虽然可以实现内存到虚拟内存的转换功能，但是直接这样实现话，页表本身又占用了太多的内存。

![在这里插入图片描述](/img/csdn/4e25eb557be1.png)
...
![在这里插入图片描述](/img/csdn/527ca245cbef.png)
...
![在这里插入图片描述](/img/csdn/aec3c7ac7449.png)
...
![在这里插入图片描述](/img/csdn/8aa08bee1125.png)
...
![在这里插入图片描述](/img/csdn/5c9b2c4ad417.png)
...
![在这里插入图片描述](/img/csdn/8507ec262240.png)
...
![在这里插入图片描述](/img/csdn/13284b0811ff.png)
...
![在这里插入图片描述](/img/csdn/0f0adc123018.png)
...
![在这里插入图片描述](/img/csdn/cc6be7d9bb51.png)
...
![在这里插入图片描述](/img/csdn/6da00bf9a4b4.png)
...
![在这里插入图片描述](/img/csdn/8274eb96e6d6.png)
...
![在这里插入图片描述](/img/csdn/6c784e30b08b.png)
...
![在这里插入图片描述](/img/csdn/c611d500255d.png)
...
![在这里插入图片描述](/img/csdn/85d59cc1ec86.png)
...
![在这里插入图片描述](/img/csdn/958bc46a109a.png)
...
![在这里插入图片描述](/img/csdn/d25a7970acd0.png)
...
![在这里插入图片描述](/img/csdn/539736f743ba.png)
...
![在这里插入图片描述](/img/csdn/e5f7e542f245.png)

![在这里插入图片描述](/img/csdn/de0fd3de265d.png)
...
![在这里插入图片描述](/img/csdn/97866485c91f.png)
...
![在这里插入图片描述](/img/csdn/a9cd9dcbfe80.png)
...
![在这里插入图片描述](/img/csdn/21b9b29f53a3.png)
...
![在这里插入图片描述](/img/csdn/639e6e130d4f.png)
...
![在这里插入图片描述](/img/csdn/75c502689001.png)
...
![在这里插入图片描述](/img/csdn/95f93eae0f6e.png)
...
![在这里插入图片描述](/img/csdn/886494f9c001.png)
...
![在这里插入图片描述](/img/csdn/be2156c8a394.png)
