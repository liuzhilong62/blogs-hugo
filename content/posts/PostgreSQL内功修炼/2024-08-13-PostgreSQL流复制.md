...
![PG流复制原理](/img/csdn/973437b5ba70.png)
 ...
 **主从同步关系**
![在这里插入图片描述](/img/csdn/43bd95ea31d5.png)

**主从可靠性**
![在这里插入图片描述](/img/csdn/647bc630a1ef.png)
...
![ddl时查询冲突](/img/csdn/2d333af63baa.png)
...
上面只介绍了1种查询冲突的情况。总结一下有以下几种情况
 ...
 3. 主库删除了从库查询正在使用的表空间
 4. 主库删除了从库正在使用的数据库
![vacuum时查询冲突](/img/csdn/2194edd3e8af.png)
