...
![在这里插入图片描述](/img/csdn/fec3e1c0263f.png)
...
![在这里插入图片描述](/img/csdn/f34dabdc091c.png)
...
![在这里插入图片描述](/img/csdn/4bcffb429099.png)
...
![在这里插入图片描述](/img/csdn/5c9458f68c2e.png)
...
![在这里插入图片描述](/img/csdn/9b24ddaad8e7.png)
...
![在这里插入图片描述](/img/csdn/7b272ed64104.png)
...
![在这里插入图片描述](/img/csdn/a226f3f1899f.png)
...
![在这里插入图片描述](/img/csdn/f3fc29d1f5cd.png)
...
![在这里插入图片描述](/img/csdn/20abc423c1e9.png)
...
![在这里插入图片描述](/img/csdn/2b45752abb3b.png)
...
![在这里插入图片描述](/img/csdn/661dba35e09a.png)
...
![在这里插入图片描述](/img/csdn/d21a425177c0.png)
...
![在这里插入图片描述](/img/csdn/9914756afd16.png)
...
![在这里插入图片描述](/img/csdn/fb637c9d769e.png)
...
![在这里插入图片描述](/img/csdn/7cfae9b6cfff.png)
...
![在这里插入图片描述](/img/csdn/53c4660e122d.png)![在这里插入图片描述](/img/csdn/fb09a2a553f8.png)
...
![在这里插入图片描述](/img/csdn/f490c66d7714.png)
...
![在这里插入图片描述](/img/csdn/a7e8e0b28860.png)
...
![在这里插入图片描述](/img/csdn/f63754993caa.png)
...
![在这里插入图片描述](/img/csdn/2103e76b673a.png)
...
![在这里插入图片描述](/img/csdn/656f08fc9ac3.png)

![在这里插入图片描述](/img/csdn/05d79891bd23.png)
...
![在这里插入图片描述](/img/csdn/157f00ff6b48.png)
...
![在这里插入图片描述](/img/csdn/815fee8ad284.png)
...
![在这里插入图片描述](/img/csdn/49ae172a7923.png)
...
![在这里插入图片描述](/img/csdn/891a4e0ed575.png)
...
![在这里插入图片描述](/img/csdn/0ee340aa3ea8.png)
...
![在这里插入图片描述](/img/csdn/46ee8f7372ff.png)
...
![在这里插入图片描述](/img/csdn/9c5cdfb1d385.png)
...
![在这里插入图片描述](/img/csdn/bf06b10cd015.png)
...
![在这里插入图片描述](/img/csdn/93a3ccefbd2d.png)
...
![在这里插入图片描述](/img/csdn/16040258a95a.png)

(2)t2更新同一行会被阻塞，本次阻塞通过transactionid的sharelock锁实现，relation、tuple锁 T2都会获得：

![在这里插入图片描述](/img/csdn/2cca36c19235.png)

![在这里插入图片描述](/img/csdn/d3b2e8a88a88.png)

(3)t3再更新这个行，本次阻塞通过tuple排他锁实现



![在这里插入图片描述](/img/csdn/9f0527a73a0a.png)

![在这里插入图片描述](/img/csdn/b5ea7c9fe3f1.png)

总之，**PG的行锁通过transactionid锁、relation锁和tuple锁共同实现：**

![在这里插入图片描述](/img/csdn/5160903bb82b.png)
...
![在这里插入图片描述](/img/csdn/d8149234af0e.png)
...
![在这里插入图片描述](/img/csdn/2fde90f69b14.png)
...
![在这里插入图片描述](/img/csdn/b45d38154897.png)
...
![在这里插入图片描述](/img/csdn/748bd7fc3712.png)
...
![在这里插入图片描述](/img/csdn/ed1ce367a7b8.png)
...
![在这里插入图片描述](/img/csdn/e7604c9266a6.png)
...
![在这里插入图片描述](/img/csdn/78b4331a5822.png)
...
![在这里插入图片描述](/img/csdn/b3c6ace6a20f.png)

![在这里插入图片描述](/img/csdn/3578c8002447.png)
...
![在这里插入图片描述](/img/csdn/b85525616eeb.png)

google云原生架构（MIG）：

![在这里插入图片描述](/img/csdn/0cc376b9b922.png)
...
![在这里插入图片描述](/img/csdn/6c3c996ceeb5.png)
...
![在这里插入图片描述](/img/csdn/f2ec64d6d8a4.png)
...
![在这里插入图片描述](/img/csdn/bbce62f757b4.png)
...
![在这里插入图片描述](/img/csdn/57a0de81e82c.png)
...
![在这里插入图片描述](/img/csdn/47912e7b0750.png)
...
![在这里插入图片描述](/img/csdn/d24f548bb484.png)
...
![在这里插入图片描述](/img/csdn/1e864c9bc4a1.png)
...
![在这里插入图片描述](/img/csdn/4a5a7f3ac437.png)

有HOT的情况下，页内的更新只会更新元组，不会更新索引：

![在这里插入图片描述](/img/csdn/e618933424af.png)
...
![在这里插入图片描述](/img/csdn/c220fe22e28a.png)
...
![在这里插入图片描述](/img/csdn/b2b9809f61d7.png)
...
![在这里插入图片描述](/img/csdn/a3a4118829be.png)
...
![在这里插入图片描述](/img/csdn/a158c01929e8.png)
...
## 三十一、SQL 慢能从哪些方面入手排查
![在这里插入图片描述](/img/csdn/2e1b3f17a0b2.png)
...
![在这里插入图片描述](/img/csdn/d0c6c3c47a5b.png)
...
![在这里插入图片描述](/img/csdn/664b2fe2f965.png)
...
![在这里插入图片描述](/img/csdn/9f0b4a87e536.png)
...
![在这里插入图片描述](/img/csdn/d6a9535557f7.png)
...
![在这里插入图片描述](/img/csdn/b2a8526ef63d.png)
...
![在这里插入图片描述](/img/csdn/f1fe82c3a6ce.png)

三次握手完成后，PSQL客户端立即向PG server发送开始建立PGSQL协议的消息[4]，info为>?，为协议启动消息

![在这里插入图片描述](/img/csdn/376c522b4dd8.png)
...
![在这里插入图片描述](/img/csdn/8c246946c86e.png)
...
![在这里插入图片描述](/img/csdn/c25bdda59915.png)
